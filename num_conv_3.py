def conv_num(num_str):
    ...
    for char in range(0, len(num_str)):
        ...
        first_char_zero_flag = is_number(char, converted_char, sign_flag)
        decimal_flag = is_decimal(converted_char, second_char_x_flag)
        is_hex_letter(converted_char, first_char_zero_flag, second_char_x_flag)
...
def is_decimal(converted_char, flag):
    decimal_flag = False
